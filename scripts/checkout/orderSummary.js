...
export function renderOrderSummary() {
            ...
            <div class="cart-item-details-grid">
                ...
                <div class="product-quantity js-product-quantity-${
                  matchingProduct.id
                    ...
                    <span class="update-quantity-link link-primary js-link-primary" data-product-id="${
                      matchingProduct.id
                    }">
                    Update
                    </span>
                    <input class="quantity-input js-quantity-input" type="number" min = 0 data-product-id="${
                      matchingProduct.id
                    }">
                    <span class="save-quantity-link link-primary js-save-link-primary" data-product-id="${
                      matchingProduct.id
                    }">Save</span>
  ...
  document.querySelectorAll(".js-save-link-primary").forEach((link) => {
    // Save Link
    link.addEventListener("click", () => {
      const { productId } = link.dataset;
  ...
  document.querySelectorAll(".js-delivery-option").forEach((option) => {
    option.addEventListener("click", () => {
      ...
      cart.updateDeliverOption(productId, deliveryOptionId);
      renderOrderSummary();
      renderPaymentSummary();
    });
  });
  ...
  if (cart.updateCartQuantityNumber() === 0) {
    orderStatus();
  }
}
